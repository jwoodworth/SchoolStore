        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoriteSchool = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipCost = table.Column<decimal>(nullable: true),
                    ...
                    TotalDue = table.Column<decimal>(nullable: true),
                    TrackingNumber = table.Column<Guid>(nullable: false),
                    UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderLineItem_OrderHeader_OrderHeaderID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceSurcharge = table.Column<decimal>(nullable: false),
                    ProductID = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductConfiguration_Color_ColorID",
                        column: x => x.ColorID,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductConfiguration_Size_SizeID",
                        column: x => x.SizeID,
                        principalTable: "Size",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderLineItem_OrderHeaderID",
                table: "OrderLineItem",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductConfiguration_ColorID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductConfiguration_SizeID",
                table: "ProductConfiguration",
                column: "SizeID");
